...
const Rain = () => {
	...
	return (
		<motion.div
			...
			className={`w-full`}
		>
			<div className="w-full rounded-lg py-2 px-4 mix-blend-soft-light transition-colors relative overflow-hidden group h-[115px] flex flex-col justify-evenly">
				<div className={`flex  justify-center gap-3 items-center`}>
					...
					<div className="flex flex-col items-center">
						...
						<div className={`text-xs tracking-widest  leading-4 text-sky-600`}>
							today on average
						</div>
					</div>
				</div>
