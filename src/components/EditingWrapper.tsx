	...
	return (
		<div className="relative ">
			...
			{!isPreview && (
				...
				>
					<GripVertical className="text-neutral-400 dark:group-hover:text-neutral-100 group-hover:text-neutral-800 h-5 w-5  group-hover/button:scale-105 transition-all group-active/button:scale-95 duration-500" />
				</button>
			)}
		</div>
	);
